  ...
  return (
    <div className=" relative overflow-hidden">
      ...
      <section className=" relative h-screen flex justify-center items-center bg-[url('/bgG.jpg')] bg-cover bg-fixed bg-center">
        <h2
          className=" absolute md:text-3xl lg:text-7xl text-[#ff4655]"
          id="text"
        ...
        />
        <Image
          className=" lg:hidden bottom-0 w-4/12 h-2/4 lg:h-3/4 left-0 fixed"
          src={omen}
          id="gate-left"
        ...
        />
        <Image
          className=" lg:hidden bottom-0 w-3/12 h-2/4 lg:h-3/4 right-10 fixed"
          src={skye}
          id="gate-right"
          style={{
